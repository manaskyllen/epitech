    ...
    testWidgets('should contain a functional back button and resend email link', (WidgetTester tester) async {
      ...
      expect(
        find.byWidgetPredicate(
          (widget) => widget is Image && widget.image is AssetImage && (widget.image as AssetImage).assetName == 'assets/images/back.png'
        ),
        findsOneWidget,
      );
      ...
      expect(
        find.byWidgetPredicate(
          ...
          widget.text.toPlainText().contains('Didn\'t receive the email?'),
        ),
        findsOneWidget,
      );
